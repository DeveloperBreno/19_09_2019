...
class ManutencaoAdapter (
    val carros: List<Manutencao>,
    val onClick: (Manutencao) -> Unit): RecyclerView.Adapter<ManutencaoAdapter.CarrosViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CarrosViewHolder {
        ...
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.adapter_carros, parent, false)
    ...
    override fun onBindViewHolder(holder: CarrosViewHolder, position: Int) {
        ...
        holder.cardNome.text = carros.nome
        holder.cardProgress.visibility = View.VISIBLE
        Picasso.with(context).load(carros.foto)
            .fit()
            .into(holder.cardImg,
